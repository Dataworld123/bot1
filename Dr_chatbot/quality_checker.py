...
class ResponseQualityChecker:
    ...
    def check_response_quality(self, user_question: str, ai_response: str, context: str = "") -> QualityScore:
        ...
        professional_indicators = [
            "i recommend", "in my experience", "i've seen", "i do", "i perform",
            "based on", "clinically", "professional"
        ]
        if not any(indicator in ai_response.lower() for indicator in professional_indicators):
            issues.append(QualityIssue.INAPPROPRIATE_TONE)
            suggestions.append("Use more professional dental terminology and experience-based language")
        else:
            strengths.append("Maintains professional dental expertise tone")
        ...
        action_indicators = [
            "you should", "i recommend", "try", "use", "avoid", "schedule",
